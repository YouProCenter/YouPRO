$(function() {
  $(".g-form1").submit(function (event) {
    event.preventDefault();
 
    // Ссылка, которую получили на этапе публикации приложения
    let appLink = "https://script.google.com/macros/s/AKfycbzSNM97tlGsyMlEh_DG2cuENlzfk2nTD-DFh2zN/exec";
    ...
    let submitButton = $(this).find('.g-form__button1');
